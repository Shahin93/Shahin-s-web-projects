<%-- 
    Document   : contact
    Created on : Nov 28, 2013, 1:09:36 PM
    Author     : General
--%>
					...
					<!-- Everything you want hidden at 940px or less, place within here -->
						...
						<!-- .nav, .navbar-search, .navbar-form, etc -->
							<ul class="sf-menu">
								...
								<li class="deeper parent current"><a href="contact.jsp">Contact Us</a></li>	
							</ul>
							<div class="search">
			...
			<div class="container main">
				<div class="row">
					...
					<div id="commentform">
						...
						<form method="post" id="contact_us" action="http://demo.webpentagon.com/themeforest/html/bestshop/sendemail.php">
							<p><input type="text" name="Name" id="Name" class="width" value="" size="42" tabindex="1" />
							<label><small>Name<strong>*</strong></small></label></p>
